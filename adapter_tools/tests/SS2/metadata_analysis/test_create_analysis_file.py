...
# Outputs.json respresents the merged list of the bam and bai analysis metadata files
def test_analysis_file(analysis_file_input):
    analysis_outputs = caf.test_build_analysis_file_ss2(analysis_file_input)
