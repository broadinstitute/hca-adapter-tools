...
def test_create_analysis_protocol(analysis_protocol_input):
    analysis_protocol_file = cap.test_build_analysis_protocol(
        analysis_protocol_input['input_uuid'],
        analysis_protocol_input['pipeline_type'],
        analysis_protocol_input['pipeline_version'],
        analysis_protocol_input['workspace_version'],
        analysis_protocol_input['project_level'],
    )
