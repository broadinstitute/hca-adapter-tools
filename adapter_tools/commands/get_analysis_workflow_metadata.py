...
from adapter_tools.utilities.http_requests import HttpRequests
...
def get_metadata(
    ...
    url = '{0}/api/workflows/v1/{1}/metadata?expandSubWorkflows={2}'.format(
        base_url, workflow_id, include_subworkflows.lower()
    )
